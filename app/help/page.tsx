      ...
      <div className='flex flex-col sm:flex-row gap-8 mt-14'>
        ...
        <div className='w-full sm:w-[70%] lg:w-[75%]'>
          ...
          <div className='flex flex-col gap-3 mt-8'>
            ...
            <a href="#" className='underline text-base sm:text-lg'>WHAT ARE NIKE'S DELIVERY OPTIONS?</a>
            <a href="#" className='underline  text-base sm:text-lg mb-5'>HOW DO I GET FREE DELIVERY ON NIKE ORDERS?</a>
          </div>
        </div>
