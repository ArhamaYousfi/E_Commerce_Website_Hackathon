...
import men from "../(public)/Image (2).png"
import shoe from "../(public)/Image.png"
import heart from "../(public)/VectorHeart.svg"
import trash from "../(public)/Frame.Delete-Icon.svg"
          ...
          <div className="md:w-[60%]">
            <div className="p-[10px] px-[10px] md:p-[10px] md:px-[10px] bg-[#F7F7F7]">
              ...
              <div className="flex justify-between md:flex md:gap-x-5">
                <p className="text-[16px] font-[400] md:text-[11px] md:font-[400]">
                  Applies to orders of ₹ 14 000.00 <span className="underline font-bold">View details</span> or more.
                </p>
              </div>
            </div>
            ...
            <div className="py-[30px] mb-8  md:flex md:gap-x-5 md:py-[30px] border-b-[2px]">
              ...
              <div className="md:w-[100%]">
                ...
                <div className="mt-3 font-[400] text-[16px] text-[#757575] w-fit md:font-[400] md:text-[14px] md:mt-0 md:text-[#757575] md:w-fit">
                  <p className="mt-1 md:mt-1">Men's Shoes</p>
                  <p className="mt-1 md:mt-1">Men's Pewter/Light Bone/Black/White</p>
                  <div className="mt-3 flex justify-between md:mt-2 md:flex md:justify-between">
                    <div className="flex gap-2 md:flex md:gap-2">
                      <p>Size</p>
                      <p>8</p>
